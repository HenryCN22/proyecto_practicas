...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/Plantilla/images/fav.png">
    <!-- Custom CSS -->
 ...
 font-weight:normal;
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ route('home') }}" style="padding:8px">
                        <!-- Logo text -->
                        <span><img src="/imagen/tts.png" alt="homepage" class="dark-logo" style="height: 70px" /></span>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li class="active">
                            <a href="#homeSubmenu" aria-expanded="false" ><i class=""></i><span class="hide-menu">INDIVIDUAL</span></a>
                        </li> --}}
                        {{-- MANTENIMIENTO --}}
                        <li class="nav-devider"></li>
                        <li>
                            <a href="#mantenimiento" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-book"></i><span class="hide-menu">MANTENIMIENTO</span></a>
                        ...
                        <li class="nav-devider"></li>
                        <li>
                            <a href="#producto" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-layer-group"></i><span class="hide-menu">PRODUCTOS</span></a>
                            <ul class="collapse list-unstyled" id="producto">
                                <li>
                                    <a href="{{route('product.list')}}">LISTA PRODUCTOS</a>
                                </li>
                                <li>
                        ...
                        <li class="nav-devider"></li>
                        <li>
                            <a href="#compras" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-hand-holding-usd"></i><span class="hide-menu">COMPRAS</span></a>
                        ...
                        <li class="nav-devider"></li>
                        <li>
                            <a href="#ventas" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-cart-plus"></i><span class="hide-menu">VENTAS</span></a>
                            <ul class="collapse list-unstyled" id="ventas">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled" id="cliente">
                                        <li>
                                            <a href="{{route('customer.list')}}">LISTA CLIENTES</a>
                                        </li>
                                        <li>
                                            <a href="{{route('customer.create')}}">NUEVO CLIENTE</a>
                                        </li>
                        ...
                        <li class="nav-devider"></li>
                        <li>
                            <a href="#reportes" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fas fa-square"></i><span class="hide-menu">REPORTES</span></a>
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <footer class="footer"> © 2023 Todos los Derechos Reservados.</footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
