...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
        <div class="container-fluid">
            ...
            <a class="logo text-uppercase" href="index.html">
                <img src="" alt="" class="logo-light" height="80px" />
            </a>
    ...
    <!-- home start -->
    <section class="bg-home bg-danger" id="home">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-6">
                            <div class="home-title text-white">
                                <h2 class="mb-4">ALIMENTOS BALANCEADOS E.I.R.L.</h2>
                                <p class="text-white-50 home-desc font-16 mb-5">Gestión Comercial</p>
                                <div class="watch-video mt-5">
                                    @guest
                                    @if(Route::has('register'))
                                        <a href="{{ route('login') }}" class="btn btn-success mr-4">Iniciar Sesión <i class="mdi mdi-chevron-right ml-1"></i></a>
                                    @endif
                                    @else
                                        <a href="{{ route('home') }}" class="btn btn-success mr-4">Menú Principal<i class="mdi mdi-chevron-right ml-1"></i></a>
                                    @endguest
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5 offset-lg-1 col-sm-6">
                            <div class="home-img mo-mt-20">
                                <img src="/Landing/images/loo1.png" alt="" class="img-fluid mx-auto d-block">
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="text-center">
                        <p class="text-white-50 mb-4">2023 © Todos los derechos recervados.</p>
