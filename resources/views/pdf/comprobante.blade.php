                                    ...
                                    <div class="row">
                                        <div class="col-md-11">
                                            <div style="width: 20%; height: 180px; float: left; margin-right: 25px">
                                                <img src="/imagen/fav.png" style="height: 100%" >
                                            </div>
                                            <div style="width: 47%; height: 180px; float: left">
                                                <div class="row" style="text-align:center">
                                                    <h1>A. BALANCEADOS E.I.R.L.</h1>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-11" style="text-align:center">
                                                        <p style="font-size: 15px">VENTA DE ALIMENTOS BALANCEADOS</p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                            ...
                                            <div style="width: 29%; height: 180px; float: left">
                                                <div class="row" style="text-align:center">
                                                    <b style="font-size: 25px">R.U.C. 20607017809</b>
                                            ...
                                            <div class="row" style="margin-top: 30px">
                                                <div class="col-md-7">
                                                    <p class="fw-normal" style="font-size: 11px">
                                                        Dirección : Cal. alle de, Jose de Sucre N°21854 <br>
                                                        El Porvenir - Trujillo - La Libertad - Cel : 968 888 444
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
